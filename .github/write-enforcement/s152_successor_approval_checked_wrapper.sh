...
CANONICAL_WRAPPER=$CANONICAL_ROOT/.github/write-enforcement/s152_successor_approval_checked_wrapper.sh
CANONICAL_HELPER=$CANONICAL_ROOT/.github/write-enforcement/s152_successor_approval_resume.py
DEPLOYED_WRAPPER=/home/azureuser/.local/libexec/rea_enforcement/s152_successor_approval_checked_wrapper.sh
...
git -C "$CANONICAL_ROOT" diff --quiet HEAD -- \
    .github/write-enforcement/s152_successor_approval_checked_wrapper.sh \
...
export REA_S152_CHECKED_WRAPPER=rea-s152-public-successor-approval-v1
case "${1-}" in
