...
EXPECTED_MEMBERS = {
    ...
    # Exact transitive scaffold-installer inputs named by the signed hybrid
    # install manifest. These are comparison inputs, not mutable checkout
    # conveniences, so every repository/path pair is a frozen member.
    "hybrid-package-init": ("research_enforcement_activation", "write_integrity/hybrid/__init__.py"),
    "hybrid-durable-spend": ("research_enforcement_activation", "write_integrity/hybrid/durable_spend.py"),
    "hybrid-protocol": ("research_enforcement_activation", "write_integrity/hybrid/protocol.py"),
    "hybrid-authorized-mapping-schema": ("research_enforcement_activation", "write_integrity/hybrid/schemas/authorized_mapping.schema.json"),
    "hybrid-external-evidence-receipt-schema": ("research_enforcement_activation", "write_integrity/hybrid/schemas/external_evidence_receipt.schema.json"),
    "hybrid-claim-lineage-schema": ("research_enforcement_activation", "write_integrity/hybrid/schemas/hybrid_claim_lineage.schema.json"),
    "hybrid-project-close-receipt-schema": ("research_enforcement_activation", "write_integrity/hybrid/schemas/project_close_receipt.schema.json"),
    "hybrid-revocation-registry-schema": ("research_enforcement_activation", "write_integrity/hybrid/schemas/revocation_registry.schema.json"),
    "hybrid-route-neutral-capability-schema": ("research_enforcement_activation", "write_integrity/hybrid/schemas/route_neutral_capability.schema.json"),
    "hybrid-trusted-issuer-schema": ("research_enforcement_activation", "write_integrity/hybrid/schemas/trusted_issuer.schema.json"),
    ...
    "write-boundary-corpus-honest": ("research_enforcement_activation", "write_integrity/write_boundary/corpus/honest.jsonl"),
    "write-boundary-corpus-manifest": ("research_enforcement_activation", "write_integrity/write_boundary/corpus/manifest.json"),
    "write-boundary-corpus-planted": ("research_enforcement_activation", "write_integrity/write_boundary/corpus/planted.jsonl"),
    "write-boundary-protected-receive": ("research_enforcement_activation", "write_integrity/write_boundary/protected_receive.py"),
    "write-boundary-row-complete-verifier": ("research_enforcement_activation", "write_integrity/write_boundary/row_complete_verifier.py"),
